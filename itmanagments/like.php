...
$likeQuery = "SELECT COUNT(*) AS like_count FROM likes_dislikes WHERE idea_id = $ideaId AND like_status = 'like'";
...
<html>
    ...
    <div>
      ...
      <input type="text" id="like_status" name="like_status" placeholder="You can only selected (like or dislike )"required>
    </div> 
