...
<html >
    ...
    <form action="editcat.php" method="post">
        ...
        <p><input type="text" name="name" placeholder="Enter the category name here........." required value="<?php echo $row['name'];?>" /></p>
        <label for="description">User explantion</label>
        <p><input type="text" name="description"  placeholder="Enter idea description here..." required value="<?php echo $row['description'];?>"></p>
